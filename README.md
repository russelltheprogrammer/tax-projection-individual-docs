...
- Note About New York Itemized Deductions Calculation: It does not include the following items listed below and currently a manual adjustment will be needed. Please use 'State Specific Itemized Deductions' section to make this adjustment.
  ...
  **Adjustments - Subtraction Adjustments**
  ...
  **Adjustments - College tuition itemized deduction**
...
- First round of font style updates
